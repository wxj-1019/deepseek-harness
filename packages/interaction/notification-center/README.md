---
description: "Durable in-app notification entries collected from cordis event surfaces; user-facing only."
...
Storage schema and collectors live beside the service in this package; the UI panel is dsh-client-ui-notification-center.
