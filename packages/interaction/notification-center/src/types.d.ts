...
export declare function NotificationId(value: string): NotificationId
/** The collector vocabulary of what a notification is about. */
export type NotificationKind = 'session-completed' | 'approval-decided' | 'job-finished' | 'reminder-dispatched'
