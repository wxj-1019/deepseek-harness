...
export const zh = {
  ...
  'summary.today': '今日',
  'stat.peak': '单日峰值',
  'stat.streakCurrent': '当前连续天数',
  'stat.streakLongest': '最长连续天数',
  'card.heatmap': 'Token 活动',
  'card.trend': '每日 Token 趋势',
  'card.models': '模型用量',
  'range.7d': '近 7 日',
  'range.30d': '近 30 日',
  'col.session': '会话',
...
export const en: Record<UsageKey, string> = {
  ...
  'summary.today': 'Today',
  'stat.peak': 'Peak day',
  'stat.streakCurrent': 'Current streak',
  'stat.streakLongest': 'Longest streak',
  'card.heatmap': 'Token activity',
  'card.trend': 'Daily token trend',
  'card.models': 'Model usage',
