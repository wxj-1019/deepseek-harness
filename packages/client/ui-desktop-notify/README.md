---
description: "Browser-side desktop completion notifications for the dsh web client, backed by the sessions-list snapshot feed."
...
The watcher is a pure client consumer over the snapshot feed: no RPC, no session events, no host plugin; the e2e scenario owns the coverage.
