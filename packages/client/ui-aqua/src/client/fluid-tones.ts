 ...
 * @param dark - resolve against the dark palette.
 * @param hue - user-facing hue slider value, degrees.
 * @param depth - user-facing depth slider value, 0-100.
 * @returns the shader's three color stops. */
