---
description: "Browser-side settings page for the dev-checks namespace: per-machine quality-gate switches enforced by the wrapper."
...
Switches persist in the dev-checks settings namespace per machine; the wrapper reads the same namespace to enforce the toggles.
