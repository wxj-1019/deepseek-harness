---
description: "Browser-side pinned-session surfaces (header star, sidebar section) over the session-pins storage domain."
...
Pin state is user-facing only and never enters a session log or model request; the panel and the header star share one controller.
