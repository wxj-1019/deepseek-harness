...
| [`ui-aqua/`](ui-aqua/README.zh.md) | 应用 Aqua 玻璃视觉系统：主题 token、可调模糊与磨砂，以及 WebGL 或壁纸背景。 |
| [`ui-desktop-notify/`](ui-desktop-notify/README.zh.md) | 当任务在用户未注视会话时完成，弹出系统级桌面通知。 |
| [`ui-notification-center/`](ui-notification-center/README.zh.md) | 页脚铃铛与 shell.overlay 面板，基于通知存储域。 |
