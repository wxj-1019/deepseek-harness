...
| [`ui-desktop-notify/`](ui-desktop-notify/README.zh.md) | 任务完成且你未盯着该会话时弹出系统桌面通知。 |
...
| [`ui-session-pins/`](ui-session-pins/README.zh.md) | 会话头部星钮与侧栏置顶区块，数据来自 session-pins 存储域。 |
| [`ui-notification-center/`](ui-notification-center/README.zh.md) | 侧栏底部铃铛与 shell.overlay 面板，数据来自 notifications 存储域。 |
| [`ui-usage/`](ui-usage/README.zh.md) | “用量”设置分区：按会话的 token 计量，数据来自 usage-ledger 存储域。 |
