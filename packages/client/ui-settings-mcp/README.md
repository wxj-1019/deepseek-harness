---
description: "Browser-side settings card for MCP server composition over the settings seam."
...
Server definitions persist in the mcp-servers settings namespace; the mcp-client bridge recomposes on change and owns every connection.
