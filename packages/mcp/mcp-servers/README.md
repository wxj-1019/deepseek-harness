---
description: "Settings-driven MCP server composition and lifecycle for the dsh host."
...
Composition is declarative in the settings namespace; the bridge owns connections, and this package owns none of the wire protocol.
