...
Requires: `storageDomain` · `tools` · `systemPrompt` · `skills` · `settings`
...
Source: [`packages/storage/component-library/src/index.ts:75`](../packages/storage/component-library/src/index.ts)
...
Source: [`packages/llm/llm-deepseek/src/index.ts:133`](../packages/llm/llm-deepseek/src/index.ts)
...
Source: [`packages/llm/llm-vision-route/src/index.ts:52`](../packages/llm/llm-vision-route/src/index.ts)

<a id="deepseek-aidsh-lsp-stdio"></a>

## `@deepseek-ai/dsh-lsp-stdio`

Requires: `fs` · `lsp` · `subprocess` · `systemPrompt`
...
Requires: `tools` · `lsp` · `systemPrompt` · `fs`
...
- `@deepseek-ai/dsh-git-graph` — requires `webServer` · `sessionController` ([`packages/web/git-graph/src/index.ts`](../packages/web/git-graph/src/index.ts))
...
- `@deepseek-ai/dsh-mcp-servers` — requires `settings` ([`packages/mcp/mcp-servers/src/index.ts`](../packages/mcp/mcp-servers/src/index.ts))
...
- `@deepseek-ai/dsh-tool-compact` — requires `tools` · `systemPrompt` ([`packages/compaction/tool-compact/src/index.ts`](../packages/compaction/tool-compact/src/index.ts))
