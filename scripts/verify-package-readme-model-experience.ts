...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-desktop-notify': { kind: 'none', reason: 'Browser-side settings row plus an OS-level notification; nothing the package renders reaches a prompt, schema, stream, or tool result.' },
  ...
  'packages/client/ui-settings-vision-model': { kind: 'none', reason: 'Browser-side settings page for the vision-model namespace; the routing it configures is owned by dsh-llm-vision-route.' },
