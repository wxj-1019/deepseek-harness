...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/todo/user-todo': { kind: 'none', reason: 'Durable user-owned todo list in its own storage domain; user-facing only, never enters a session log or model request.' },
