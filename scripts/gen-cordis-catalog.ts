...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  sessionPins: 'session-pins.md',
  skills: 'skills.md',
  spillStore: 'spill.md',
  storage: 'storage.md',
  storageDomain: 'storage.md',
  componentLibrary: 'component-library.md',
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  visionRoute: 'optional deployment service (settings-driven image routing) declared interface-typed by dsh-llm and implemented by the dsh-llm-vision-route plugin — packages/llm/llm-vision-route/README.md owns the API',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  ComponentRecord: 'component-library vocabulary is owned by packages/storage/component-library/src/types.ts',
  ComponentMatch: 'component-library vocabulary is owned by packages/storage/component-library/src/types.ts',
  ComponentLibraryQueryRequest: 'component-library vocabulary is owned by packages/storage/component-library/src/types.ts',
  ComponentLibraryQueryResult: 'component-library vocabulary is owned by packages/storage/component-library/src/types.ts',
  ComponentLibraryRecordRequest: 'component-library vocabulary is owned by packages/storage/component-library/src/types.ts',
  ComponentLibraryRecordResult: 'component-library vocabulary is owned by packages/storage/component-library/src/types.ts',
  ComponentLibraryReviewRequest: 'component-library vocabulary is owned by packages/storage/component-library/src/types.ts',
  ComponentLibraryReviewResult: 'component-library vocabulary is owned by packages/storage/component-library/src/types.ts',
  ComponentLibrarySummaryResult: 'component-library vocabulary is owned by packages/storage/component-library/src/types.ts',
  ComponentLibraryListResult: 'component-library vocabulary is owned by packages/storage/component-library/src/types.ts',
  NotificationListResult: 'notification-center vocabulary is owned by packages/interaction/notification-center/src/types.ts',
  NotificationMarkReadRequest: 'notification-center vocabulary is owned by packages/interaction/notification-center/src/types.ts',
  NotificationMarkReadResult: 'notification-center vocabulary is owned by packages/interaction/notification-center/src/types.ts',
  NotificationMarkAllReadRequest: 'notification-center vocabulary is owned by packages/interaction/notification-center/src/types.ts',
  NotificationClearReadRequest: 'notification-center vocabulary is owned by packages/interaction/notification-center/src/types.ts',
  NotificationAckResult: 'notification-center vocabulary is owned by packages/interaction/notification-center/src/types.ts',
  SessionPinListResult: 'session-pins vocabulary is owned by packages/session/session-pins/src/types.ts',
  SessionPinRequest: 'session-pins vocabulary is owned by packages/session/session-pins/src/types.ts',
  SessionPinResult: 'session-pins vocabulary is owned by packages/session/session-pins/src/types.ts',
  SessionUnpinRequest: 'session-pins vocabulary is owned by packages/session/session-pins/src/types.ts',
  SessionUnpinResult: 'session-pins vocabulary is owned by packages/session/session-pins/src/types.ts',
  UsageLedgerListResult: 'usage-ledger vocabulary is owned by packages/session/usage-ledger/src/types.ts',
  UserTodoListResult: 'user-todo vocabulary is owned by packages/todo/user-todo/src/types.ts',
  UserTodoPutRequest: 'user-todo vocabulary is owned by packages/todo/user-todo/src/types.ts',
  UserTodoPutResult: 'user-todo vocabulary is owned by packages/todo/user-todo/src/types.ts',
  UserTodoToggleRequest: 'user-todo vocabulary is owned by packages/todo/user-todo/src/types.ts',
  UserTodoToggleResult: 'user-todo vocabulary is owned by packages/todo/user-todo/src/types.ts',
  UserTodoDeleteRequest: 'user-todo vocabulary is owned by packages/todo/user-todo/src/types.ts',
  UserTodoDeleteResult: 'user-todo vocabulary is owned by packages/todo/user-todo/src/types.ts',
}
