...
const PLUGINS: readonly (WebBootEntry & { bundlePath: string })[] = [
  ...
  { id: '@deepseek-ai/dsh-client-ui-aqua', bundlePath: 'packages/client/ui-aqua/lib/client.js', url: '/plugins/ui-aqua.js', rev: 'fx', inject: ['@deepseek-ai/dsh-client-connection', '@deepseek-ai/dsh-client-runtime', '@deepseek-ai/dsh-client-locale', '@deepseek-ai/dsh-client-ui-theme', '@deepseek-ai/dsh-client-ui-settings', '@deepseek-ai/dsh-api-remotes'], immediately: true },
