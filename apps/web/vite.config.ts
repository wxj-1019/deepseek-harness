  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        // Component live-preview registry: a page-global script the gallery
        // consumes through window.__DSH_STORIES__ (see stories-entry.ts).
        stories: src('./src/stories-entry.ts'),
      },
      output: {
